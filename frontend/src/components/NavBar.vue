...
<template>
  <nav
    class="fixed inset-x-0 top-0 z-30 h-14 w-screen bg-white/90 dark:bg-slate-950/90 backdrop-blur-md transition-(--transition-position) lg:w-auto border-b border-slate-100 dark:border-slate-800"
  >
